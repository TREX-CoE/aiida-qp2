...
echo %s > %s/ezfio/library"""%(filename,filename,self.LIBRARY,filename))
  ...
  ezfio_last_library = property(fset=set_ezfio_last_library,      fget=get_ezfio_last_library)
  ...
  ao_basis_ao_num = property(fset=set_ao_basis_ao_num,      fget=get_ao_basis_ao_num)
  ...
  def get_ao_basis_ao_prim_num(self):
    ...
    try:
     result = self.read_array_in(self.path_ao_basis,'ao_prim_num', rank,dims,dim_max)
    finally:
  ...
  def set_ao_basis_ao_prim_num(self,ao_prim_num):
    ...
    self.acquire_lock('ao_basis_ao_prim_num')
    try:
     self.write_array_in(self.path_ao_basis,'ao_prim_num', rank,dims,dim_max,ao_prim_num)
    finally:
     self.release_lock('ao_basis_ao_prim_num')

  ao_basis_ao_prim_num = property(fset=set_ao_basis_ao_prim_num,fget=get_ao_basis_ao_prim_num)

  def has_ao_basis_ao_prim_num(self):
    return (os.access(self.path_ao_basis+'/ao_prim_num.gz',os.F_OK) == 1)
  ...
  def get_ao_basis_ao_nucl(self):
    ...
    try:
     result = self.read_array_in(self.path_ao_basis,'ao_nucl', rank,dims,dim_max)
    finally:
  ...
  def set_ao_basis_ao_nucl(self,ao_nucl):
    ...
    self.acquire_lock('ao_basis_ao_nucl')
    try:
     self.write_array_in(self.path_ao_basis,'ao_nucl', rank,dims,dim_max,ao_nucl)
    finally:
     self.release_lock('ao_basis_ao_nucl')
  ...
  def get_ao_basis_ao_power(self):
    ...
    try:
     result = self.read_array_in(self.path_ao_basis,'ao_power', rank,dims,dim_max)
    finally:
  ...
  def set_ao_basis_ao_power(self,ao_power):
    ...
    self.acquire_lock('ao_basis_ao_power')
    try:
     self.write_array_in(self.path_ao_basis,'ao_power', rank,dims,dim_max,ao_power)
    finally:
     self.release_lock('ao_basis_ao_power')

  ao_basis_ao_power = property(fset=set_ao_basis_ao_power,fget=get_ao_basis_ao_power)
  ...
  def get_ao_basis_ao_coef(self):
    ...
    try:
     result = self.read_array_re(self.path_ao_basis,'ao_coef', rank,dims,dim_max)
    finally:
  ...
  def set_ao_basis_ao_coef(self,ao_coef):
    ...
    self.acquire_lock('ao_basis_ao_coef')
    try:
     self.write_array_re(self.path_ao_basis,'ao_coef', rank,dims,dim_max,ao_coef)
    finally:
     self.release_lock('ao_basis_ao_coef')

  ao_basis_ao_coef = property(fset=set_ao_basis_ao_coef,fget=get_ao_basis_ao_coef)
  ...
  def get_ao_basis_ao_expo(self):
    ...
    try:
     result = self.read_array_re(self.path_ao_basis,'ao_expo', rank,dims,dim_max)
    finally:
  ...
  def set_ao_basis_ao_expo(self,ao_expo):
    ...
    self.acquire_lock('ao_basis_ao_expo')
    try:
     self.write_array_re(self.path_ao_basis,'ao_expo', rank,dims,dim_max,ao_expo)
    finally:
     self.release_lock('ao_basis_ao_expo')

  ao_basis_ao_expo = property(fset=set_ao_basis_ao_expo,fget=get_ao_basis_ao_expo)
  ...
  nuclei_nucl_num = property(fset=set_nuclei_nucl_num,      fget=get_nuclei_nucl_num)
  ...
  def get_nuclei_nucl_label(self):
    ...
    try:
     result = self.read_array_ch(self.path_nuclei,'nucl_label', rank,dims,dim_max)
    finally:
  ...
  def set_nuclei_nucl_label(self,nucl_label):
    ...
    self.acquire_lock('nuclei_nucl_label')
    try:
     self.write_array_ch(self.path_nuclei,'nucl_label', rank,dims,dim_max,nucl_label)
    finally:
     self.release_lock('nuclei_nucl_label')

  nuclei_nucl_label = property(fset=set_nuclei_nucl_label,fget=get_nuclei_nucl_label)
  ...
  def get_nuclei_nucl_charge(self):
    ...
    try:
     result = self.read_array_re(self.path_nuclei,'nucl_charge', rank,dims,dim_max)
    finally:
  ...
  def set_nuclei_nucl_charge(self,nucl_charge):
    ...
    self.acquire_lock('nuclei_nucl_charge')
    try:
     self.write_array_re(self.path_nuclei,'nucl_charge', rank,dims,dim_max,nucl_charge)
    finally:
     self.release_lock('nuclei_nucl_charge')

  nuclei_nucl_charge = property(fset=set_nuclei_nucl_charge,fget=get_nuclei_nucl_charge)
  ...
  def get_nuclei_nucl_coord(self):
    ...
    try:
     result = self.read_array_re(self.path_nuclei,'nucl_coord', rank,dims,dim_max)
    finally:
  ...
  def set_nuclei_nucl_coord(self,nucl_coord):
    ...
    self.acquire_lock('nuclei_nucl_coord')
    try:
     self.write_array_re(self.path_nuclei,'nucl_coord', rank,dims,dim_max,nucl_coord)
    finally:
     self.release_lock('nuclei_nucl_coord')
  ...
  jastrow_j2e_type = property(fset=set_jastrow_j2e_type,      fget=get_jastrow_j2e_type)
  ...
  jastrow_j1e_type = property(fset=set_jastrow_j1e_type,      fget=get_jastrow_j1e_type)
  ...
  jastrow_env_type = property(fset=set_jastrow_env_type,      fget=get_jastrow_env_type)
  ...
  jastrow_jbh_size = property(fset=set_jastrow_jbh_size,      fget=get_jastrow_jbh_size)
  ...
  def get_jastrow_jbh_ee(self):
    ...
    try:
     result = self.read_array_re(self.path_jastrow,'jbh_ee', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_jbh_ee(self,jbh_ee):
    ...
    self.acquire_lock('jastrow_jbh_ee')
    try:
     self.write_array_re(self.path_jastrow,'jbh_ee', rank,dims,dim_max,jbh_ee)
    finally:
     self.release_lock('jastrow_jbh_ee')
  ...
  def get_jastrow_jbh_en(self):
    ...
    try:
     result = self.read_array_re(self.path_jastrow,'jbh_en', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_jbh_en(self,jbh_en):
    ...
    self.acquire_lock('jastrow_jbh_en')
    try:
     self.write_array_re(self.path_jastrow,'jbh_en', rank,dims,dim_max,jbh_en)
    finally:
     self.release_lock('jastrow_jbh_en')
  ...
  def get_jastrow_jbh_c(self):
    ...
    try:
     result = self.read_array_re(self.path_jastrow,'jbh_c', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_jbh_c(self,jbh_c):
    ...
    self.acquire_lock('jastrow_jbh_c')
    try:
     self.write_array_re(self.path_jastrow,'jbh_c', rank,dims,dim_max,jbh_c)
    finally:
     self.release_lock('jastrow_jbh_c')
  ...
  def get_jastrow_jbh_m(self):
    ...
    try:
     result = self.read_array_in(self.path_jastrow,'jbh_m', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_jbh_m(self,jbh_m):
    ...
    self.acquire_lock('jastrow_jbh_m')
    try:
     self.write_array_in(self.path_jastrow,'jbh_m', rank,dims,dim_max,jbh_m)
    finally:
     self.release_lock('jastrow_jbh_m')
  ...
  def get_jastrow_jbh_n(self):
    ...
    try:
     result = self.read_array_in(self.path_jastrow,'jbh_n', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_jbh_n(self,jbh_n):
    ...
    self.acquire_lock('jastrow_jbh_n')
    try:
     self.write_array_in(self.path_jastrow,'jbh_n', rank,dims,dim_max,jbh_n)
    finally:
     self.release_lock('jastrow_jbh_n')
  ...
  def get_jastrow_jbh_o(self):
    ...
    try:
     result = self.read_array_in(self.path_jastrow,'jbh_o', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_jbh_o(self,jbh_o):
    ...
    self.acquire_lock('jastrow_jbh_o')
    try:
     self.write_array_in(self.path_jastrow,'jbh_o', rank,dims,dim_max,jbh_o)
    finally:
     self.release_lock('jastrow_jbh_o')
  ...
  def get_jastrow_env_expo(self):
    ...
    try:
     result = self.read_array_re(self.path_jastrow,'env_expo', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_env_expo(self,env_expo):
    ...
    self.acquire_lock('jastrow_env_expo')
    try:
     self.write_array_re(self.path_jastrow,'env_expo', rank,dims,dim_max,env_expo)
    finally:
     self.release_lock('jastrow_env_expo')

  jastrow_env_expo = property(fset=set_jastrow_env_expo,fget=get_jastrow_env_expo)
  ...
  def get_jastrow_env_coef(self):
    ...
    try:
     result = self.read_array_re(self.path_jastrow,'env_coef', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_env_coef(self,env_coef):
    ...
    self.acquire_lock('jastrow_env_coef')
    try:
     self.write_array_re(self.path_jastrow,'env_coef', rank,dims,dim_max,env_coef)
    finally:
     self.release_lock('jastrow_env_coef')

  jastrow_env_coef = property(fset=set_jastrow_env_coef,fget=get_jastrow_env_coef)
  ...
  jastrow_j1e_size = property(fset=set_jastrow_j1e_size,      fget=get_jastrow_j1e_size)
  ...
  def get_jastrow_j1e_expo(self):
    ...
    try:
     result = self.read_array_re(self.path_jastrow,'j1e_expo', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_j1e_expo(self,j1e_expo):
    ...
    self.acquire_lock('jastrow_j1e_expo')
    try:
     self.write_array_re(self.path_jastrow,'j1e_expo', rank,dims,dim_max,j1e_expo)
    finally:
     self.release_lock('jastrow_j1e_expo')

  jastrow_j1e_expo = property(fset=set_jastrow_j1e_expo,fget=get_jastrow_j1e_expo)
  ...
  def get_jastrow_j1e_coef(self):
    ...
    try:
     result = self.read_array_re(self.path_jastrow,'j1e_coef', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_j1e_coef(self,j1e_coef):
    ...
    self.acquire_lock('jastrow_j1e_coef')
    try:
     self.write_array_re(self.path_jastrow,'j1e_coef', rank,dims,dim_max,j1e_coef)
    finally:
     self.release_lock('jastrow_j1e_coef')

  jastrow_j1e_coef = property(fset=set_jastrow_j1e_coef,fget=get_jastrow_j1e_coef)
  ...
  def get_jastrow_j1e_coef_ao(self):
    ...
    try:
     result = self.read_array_re(self.path_jastrow,'j1e_coef_ao', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_j1e_coef_ao(self,j1e_coef_ao):
    ...
    self.acquire_lock('jastrow_j1e_coef_ao')
    try:
     self.write_array_re(self.path_jastrow,'j1e_coef_ao', rank,dims,dim_max,j1e_coef_ao)
    finally:
     self.release_lock('jastrow_j1e_coef_ao')

  jastrow_j1e_coef_ao = property(fset=set_jastrow_j1e_coef_ao,fget=get_jastrow_j1e_coef_ao)
  ...
  def get_jastrow_j1e_coef_ao2(self):
    ...
    try:
     result = self.read_array_re(self.path_jastrow,'j1e_coef_ao2', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_j1e_coef_ao2(self,j1e_coef_ao2):
    ...
    self.acquire_lock('jastrow_j1e_coef_ao2')
    try:
     self.write_array_re(self.path_jastrow,'j1e_coef_ao2', rank,dims,dim_max,j1e_coef_ao2)
    finally:
     self.release_lock('jastrow_j1e_coef_ao2')

  jastrow_j1e_coef_ao2 = property(fset=set_jastrow_j1e_coef_ao2,fget=get_jastrow_j1e_coef_ao2)

  def has_jastrow_j1e_coef_ao2(self):
    return (os.access(self.path_jastrow+'/j1e_coef_ao2.gz',os.F_OK) == 1)
  ...
  jastrow_mur_type = property(fset=set_jastrow_mur_type,      fget=get_jastrow_mur_type)
  ...
  jastrow_mu_r_ct = property(fset=set_jastrow_mu_r_ct,      fget=get_jastrow_mu_r_ct)
  ...
  jastrow_jpsi_type = property(fset=set_jastrow_jpsi_type,      fget=get_jastrow_jpsi_type)
  ...
  jastrow_inv_sgn_jast = property(fset=set_jastrow_inv_sgn_jast,      fget=get_jastrow_inv_sgn_jast)
  ...
  jastrow_jast_a_up_up = property(fset=set_jastrow_jast_a_up_up,      fget=get_jastrow_jast_a_up_up)
  ...
  jastrow_jast_a_up_dn = property(fset=set_jastrow_jast_a_up_dn,      fget=get_jastrow_jast_a_up_dn)
  ...
  jastrow_jast_b_up_up = property(fset=set_jastrow_jast_b_up_up,      fget=get_jastrow_jast_b_up_up)
  ...
  jastrow_jast_b_up_dn = property(fset=set_jastrow_jast_b_up_dn,      fget=get_jastrow_jast_b_up_dn)
  ...
  def get_jastrow_jast_pen(self):
    ...
    try:
     result = self.read_array_re(self.path_jastrow,'jast_pen', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_jast_pen(self,jast_pen):
    ...
    self.acquire_lock('jastrow_jast_pen')
    try:
     self.write_array_re(self.path_jastrow,'jast_pen', rank,dims,dim_max,jast_pen)
    finally:
     self.release_lock('jastrow_jast_pen')

  jastrow_jast_pen = property(fset=set_jastrow_jast_pen,fget=get_jastrow_jast_pen)
  ...
  def get_jastrow_jast_een_e_a(self):
    ...
    try:
     result = self.read_array_re(self.path_jastrow,'jast_een_e_a', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_jast_een_e_a(self,jast_een_e_a):
    ...
    self.acquire_lock('jastrow_jast_een_e_a')
    try:
     self.write_array_re(self.path_jastrow,'jast_een_e_a', rank,dims,dim_max,jast_een_e_a)
    finally:
     self.release_lock('jastrow_jast_een_e_a')

  jastrow_jast_een_e_a = property(fset=set_jastrow_jast_een_e_a,fget=get_jastrow_jast_een_e_a)

  def has_jastrow_jast_een_e_a(self):
    return (os.access(self.path_jastrow+'/jast_een_e_a.gz',os.F_OK) == 1)
  ...
  def get_jastrow_jast_een_e_b(self):
    ...
    try:
     result = self.read_array_re(self.path_jastrow,'jast_een_e_b', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_jast_een_e_b(self,jast_een_e_b):
    ...
    self.acquire_lock('jastrow_jast_een_e_b')
    try:
     self.write_array_re(self.path_jastrow,'jast_een_e_b', rank,dims,dim_max,jast_een_e_b)
    finally:
     self.release_lock('jastrow_jast_een_e_b')

  jastrow_jast_een_e_b = property(fset=set_jastrow_jast_een_e_b,fget=get_jastrow_jast_een_e_b)

  def has_jastrow_jast_een_e_b(self):
    return (os.access(self.path_jastrow+'/jast_een_e_b.gz',os.F_OK) == 1)
  ...
  def get_jastrow_jast_een_n(self):
    ...
    try:
     result = self.read_array_re(self.path_jastrow,'jast_een_n', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_jast_een_n(self,jast_een_n):
    ...
    self.acquire_lock('jastrow_jast_een_n')
    try:
     self.write_array_re(self.path_jastrow,'jast_een_n', rank,dims,dim_max,jast_een_n)
    finally:
     self.release_lock('jastrow_jast_een_n')

  jastrow_jast_een_n = property(fset=set_jastrow_jast_een_n,fget=get_jastrow_jast_een_n)
  ...
  def get_jastrow_jast_core_a1(self):
    ...
    try:
     result = self.read_array_re(self.path_jastrow,'jast_core_a1', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_jast_core_a1(self,jast_core_a1):
    ...
    self.acquire_lock('jastrow_jast_core_a1')
    try:
     self.write_array_re(self.path_jastrow,'jast_core_a1', rank,dims,dim_max,jast_core_a1)
    finally:
     self.release_lock('jastrow_jast_core_a1')

  jastrow_jast_core_a1 = property(fset=set_jastrow_jast_core_a1,fget=get_jastrow_jast_core_a1)

  def has_jastrow_jast_core_a1(self):
    return (os.access(self.path_jastrow+'/jast_core_a1.gz',os.F_OK) == 1)
  ...
  def get_jastrow_jast_core_a2(self):
    ...
    try:
     result = self.read_array_re(self.path_jastrow,'jast_core_a2', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_jast_core_a2(self,jast_core_a2):
    ...
    self.acquire_lock('jastrow_jast_core_a2')
    try:
     self.write_array_re(self.path_jastrow,'jast_core_a2', rank,dims,dim_max,jast_core_a2)
    finally:
     self.release_lock('jastrow_jast_core_a2')

  jastrow_jast_core_a2 = property(fset=set_jastrow_jast_core_a2,fget=get_jastrow_jast_core_a2)

  def has_jastrow_jast_core_a2(self):
    return (os.access(self.path_jastrow+'/jast_core_a2.gz',os.F_OK) == 1)
  ...
  def get_jastrow_jast_core_b1(self):
    ...
    try:
     result = self.read_array_re(self.path_jastrow,'jast_core_b1', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_jast_core_b1(self,jast_core_b1):
    ...
    self.acquire_lock('jastrow_jast_core_b1')
    try:
     self.write_array_re(self.path_jastrow,'jast_core_b1', rank,dims,dim_max,jast_core_b1)
    finally:
     self.release_lock('jastrow_jast_core_b1')

  jastrow_jast_core_b1 = property(fset=set_jastrow_jast_core_b1,fget=get_jastrow_jast_core_b1)

  def has_jastrow_jast_core_b1(self):
    return (os.access(self.path_jastrow+'/jast_core_b1.gz',os.F_OK) == 1)
  ...
  def get_jastrow_jast_core_b2(self):
    ...
    try:
     result = self.read_array_re(self.path_jastrow,'jast_core_b2', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_jast_core_b2(self,jast_core_b2):
    ...
    self.acquire_lock('jastrow_jast_core_b2')
    try:
     self.write_array_re(self.path_jastrow,'jast_core_b2', rank,dims,dim_max,jast_core_b2)
    finally:
     self.release_lock('jastrow_jast_core_b2')

  jastrow_jast_core_b2 = property(fset=set_jastrow_jast_core_b2,fget=get_jastrow_jast_core_b2)

  def has_jastrow_jast_core_b2(self):
    return (os.access(self.path_jastrow+'/jast_core_b2.gz',os.F_OK) == 1)


  def get_jastrow_jast_qmckl_type_nucl_num(self):
    self.acquire_lock('jastrow_jast_qmckl_type_nucl_num')
    try:
     result = self.read_in(self.path_jastrow,'jast_qmckl_type_nucl_num')
    finally:
  ...
  def set_jastrow_jast_qmckl_type_nucl_num(self,jast_qmckl_type_nucl_num):
    self.acquire_lock('jastrow_jast_qmckl_type_nucl_num')
    try:
     self.write_in(self.path_jastrow,'jast_qmckl_type_nucl_num',jast_qmckl_type_nucl_num)
    finally:
     self.release_lock('jastrow_jast_qmckl_type_nucl_num')

  jastrow_jast_qmckl_type_nucl_num = property(fset=set_jastrow_jast_qmckl_type_nucl_num,      fget=get_jastrow_jast_qmckl_type_nucl_num)

  def has_jastrow_jast_qmckl_type_nucl_num(self):
    return (os.access(self.path_jastrow+'/jast_qmckl_type_nucl_num',os.F_OK) == 1)
  ...
  def get_jastrow_jast_qmckl_type_nucl_vector(self):
    ...
    try:
     result = self.read_array_in(self.path_jastrow,'jast_qmckl_type_nucl_vector', rank,dims,dim_max)
    finally:
     self.release_lock('jastrow_jast_qmckl_type_nucl_vector')
    return result

  def set_jastrow_jast_qmckl_type_nucl_vector(self,jast_qmckl_type_nucl_vector):
    rank = 1
    dims = list(range(rank))
    dims[0] = int(self.nuclei_nucl_num)
    ...
    self.acquire_lock('jastrow_jast_qmckl_type_nucl_vector')
    try:
     self.write_array_in(self.path_jastrow,'jast_qmckl_type_nucl_vector', rank,dims,dim_max,jast_qmckl_type_nucl_vector)
    finally:
     self.release_lock('jastrow_jast_qmckl_type_nucl_vector')

  jastrow_jast_qmckl_type_nucl_vector = property(fset=set_jastrow_jast_qmckl_type_nucl_vector,fget=get_jastrow_jast_qmckl_type_nucl_vector)

  def has_jastrow_jast_qmckl_type_nucl_vector(self):
    return (os.access(self.path_jastrow+'/jast_qmckl_type_nucl_vector.gz',os.F_OK) == 1)
  ...
  def set_jastrow_jast_qmckl_rescale_ee(self,jast_qmckl_rescale_ee):
    self.acquire_lock('jastrow_jast_qmckl_rescale_ee')
    try:
     self.write_do(self.path_jastrow,'jast_qmckl_rescale_ee',jast_qmckl_rescale_ee)
    finally:
     self.release_lock('jastrow_jast_qmckl_rescale_ee')

  jastrow_jast_qmckl_rescale_ee = property(fset=set_jastrow_jast_qmckl_rescale_ee,      fget=get_jastrow_jast_qmckl_rescale_ee)

  def has_jastrow_jast_qmckl_rescale_ee(self):
    return (os.access(self.path_jastrow+'/jast_qmckl_rescale_ee',os.F_OK) == 1)
  ...
  def get_jastrow_jast_qmckl_rescale_en(self):
    ...
    try:
     result = self.read_array_do(self.path_jastrow,'jast_qmckl_rescale_en', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_jast_qmckl_rescale_en(self,jast_qmckl_rescale_en):
    ...
    self.acquire_lock('jastrow_jast_qmckl_rescale_en')
    try:
     self.write_array_do(self.path_jastrow,'jast_qmckl_rescale_en', rank,dims,dim_max,jast_qmckl_rescale_en)
    finally:
     self.release_lock('jastrow_jast_qmckl_rescale_en')

  jastrow_jast_qmckl_rescale_en = property(fset=set_jastrow_jast_qmckl_rescale_en,fget=get_jastrow_jast_qmckl_rescale_en)

  def has_jastrow_jast_qmckl_rescale_en(self):
    return (os.access(self.path_jastrow+'/jast_qmckl_rescale_en.gz',os.F_OK) == 1)
  ...
  def set_jastrow_jast_qmckl_aord_num(self,jast_qmckl_aord_num):
    self.acquire_lock('jastrow_jast_qmckl_aord_num')
    try:
     self.write_in(self.path_jastrow,'jast_qmckl_aord_num',jast_qmckl_aord_num)
    finally:
     self.release_lock('jastrow_jast_qmckl_aord_num')

  jastrow_jast_qmckl_aord_num = property(fset=set_jastrow_jast_qmckl_aord_num,      fget=get_jastrow_jast_qmckl_aord_num)

  def has_jastrow_jast_qmckl_aord_num(self):
    return (os.access(self.path_jastrow+'/jast_qmckl_aord_num',os.F_OK) == 1)
  ...
  def set_jastrow_jast_qmckl_bord_num(self,jast_qmckl_bord_num):
    self.acquire_lock('jastrow_jast_qmckl_bord_num')
    try:
     self.write_in(self.path_jastrow,'jast_qmckl_bord_num',jast_qmckl_bord_num)
    finally:
     self.release_lock('jastrow_jast_qmckl_bord_num')

  jastrow_jast_qmckl_bord_num = property(fset=set_jastrow_jast_qmckl_bord_num,      fget=get_jastrow_jast_qmckl_bord_num)

  def has_jastrow_jast_qmckl_bord_num(self):
    return (os.access(self.path_jastrow+'/jast_qmckl_bord_num',os.F_OK) == 1)
  ...
  def set_jastrow_jast_qmckl_cord_num(self,jast_qmckl_cord_num):
    self.acquire_lock('jastrow_jast_qmckl_cord_num')
    try:
     self.write_in(self.path_jastrow,'jast_qmckl_cord_num',jast_qmckl_cord_num)
    finally:
     self.release_lock('jastrow_jast_qmckl_cord_num')

  jastrow_jast_qmckl_cord_num = property(fset=set_jastrow_jast_qmckl_cord_num,      fget=get_jastrow_jast_qmckl_cord_num)

  def has_jastrow_jast_qmckl_cord_num(self):
    return (os.access(self.path_jastrow+'/jast_qmckl_cord_num',os.F_OK) == 1)


  def get_jastrow_jast_qmckl_a_vector(self):
    rank = 1
    dims = list(range(rank))
    dims[0] = int(self.jastrow_jast_qmckl_type_nucl_num*self.jastrow_jast_qmckl_aord_num+self.jastrow_jast_qmckl_type_nucl_num)
    ...
    try:
     result = self.read_array_do(self.path_jastrow,'jast_qmckl_a_vector', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_jast_qmckl_a_vector(self,jast_qmckl_a_vector):
    ...
    self.acquire_lock('jastrow_jast_qmckl_a_vector')
    try:
     self.write_array_do(self.path_jastrow,'jast_qmckl_a_vector', rank,dims,dim_max,jast_qmckl_a_vector)
    finally:
     self.release_lock('jastrow_jast_qmckl_a_vector')

  jastrow_jast_qmckl_a_vector = property(fset=set_jastrow_jast_qmckl_a_vector,fget=get_jastrow_jast_qmckl_a_vector)

  def has_jastrow_jast_qmckl_a_vector(self):
    return (os.access(self.path_jastrow+'/jast_qmckl_a_vector.gz',os.F_OK) == 1)
  ...
  def get_jastrow_jast_qmckl_b_vector(self):
    ...
    try:
     result = self.read_array_do(self.path_jastrow,'jast_qmckl_b_vector', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_jast_qmckl_b_vector(self,jast_qmckl_b_vector):
    ...
    self.acquire_lock('jastrow_jast_qmckl_b_vector')
    try:
     self.write_array_do(self.path_jastrow,'jast_qmckl_b_vector', rank,dims,dim_max,jast_qmckl_b_vector)
    finally:
     self.release_lock('jastrow_jast_qmckl_b_vector')
  ...
  def has_jastrow_jast_qmckl_b_vector(self):
    return (os.access(self.path_jastrow+'/jast_qmckl_b_vector.gz',os.F_OK) == 1)


  def get_jastrow_jast_qmckl_c_vector_size(self):
    self.acquire_lock('jastrow_jast_qmckl_c_vector_size')
    try:
     result = self.read_in(self.path_jastrow,'jast_qmckl_c_vector_size')
    finally:
  ...
  def set_jastrow_jast_qmckl_c_vector_size(self,jast_qmckl_c_vector_size):
    self.acquire_lock('jastrow_jast_qmckl_c_vector_size')
    try:
     self.write_in(self.path_jastrow,'jast_qmckl_c_vector_size',jast_qmckl_c_vector_size)
    finally:
     self.release_lock('jastrow_jast_qmckl_c_vector_size')

  jastrow_jast_qmckl_c_vector_size = property(fset=set_jastrow_jast_qmckl_c_vector_size,      fget=get_jastrow_jast_qmckl_c_vector_size)

  def has_jastrow_jast_qmckl_c_vector_size(self):
    return (os.access(self.path_jastrow+'/jast_qmckl_c_vector_size',os.F_OK) == 1)
  ...
  def get_jastrow_jast_qmckl_c_vector(self):
    ...
    try:
     result = self.read_array_do(self.path_jastrow,'jast_qmckl_c_vector', rank,dims,dim_max)
    finally:
  ...
  def set_jastrow_jast_qmckl_c_vector(self,jast_qmckl_c_vector):
    ...
    self.acquire_lock('jastrow_jast_qmckl_c_vector')
    try:
     self.write_array_do(self.path_jastrow,'jast_qmckl_c_vector', rank,dims,dim_max,jast_qmckl_c_vector)
    finally:
     self.release_lock('jastrow_jast_qmckl_c_vector')

  jastrow_jast_qmckl_c_vector = property(fset=set_jastrow_jast_qmckl_c_vector,fget=get_jastrow_jast_qmckl_c_vector)

  def has_jastrow_jast_qmckl_c_vector(self):
    return (os.access(self.path_jastrow+'/jast_qmckl_c_vector.gz',os.F_OK) == 1)
  ...
  def read_i8(self,dir,fil):
    ...
    try:
      ...
      self.error('read_i8',         'Attribute '+dir.strip()+'/'+fil+' is not set')
  ...
  def read_array_i8(self,dir,fil,rank,dims,dim_max):
    ...
    try:
      ...
      self.error('read_array_i8', 'Attribute '+l_filename+' is not set')
  ...
  def read_in(self,dir,fil):
    ...
    try:
      ...
      self.error('read_in',         'Attribute '+dir.strip()+'/'+fil+' is not set')
    dat = file.readline().strip()
    try:
      dat = conv(dat)
    except SyntaxError:
  ...
  def read_array_in(self,dir,fil,rank,dims,dim_max):
    ...
    try:
      ...
      self.error('read_array_in', 'Attribute '+l_filename+' is not set')
  ...
  def read_re(self,dir,fil):
    ...
    try:
      ...
      self.error('read_re',         'Attribute '+dir.strip()+'/'+fil+' is not set')
    dat = file.readline().strip()
    try:
      dat = conv(dat)
    except SyntaxError:
  ...
  def read_array_re(self,dir,fil,rank,dims,dim_max):
    ...
    try:
      ...
      self.error('read_array_re', 'Attribute '+l_filename+' is not set')
  ...
  def read_do(self,dir,fil):
    ...
    try:
      ...
      self.error('read_do',         'Attribute '+dir.strip()+'/'+fil+' is not set')
    dat = file.readline().strip()
    try:
      dat = conv(dat)
    except SyntaxError:
  ...
  def read_array_do(self,dir,fil,rank,dims,dim_max):
    ...
    try:
      ...
      self.error('read_array_do', 'Attribute '+l_filename+' is not set')
  ...
  def read_lo(self,dir,fil):
    ...
    try:
      ...
      self.error('read_lo',         'Attribute '+dir.strip()+'/'+fil+' is not set')
    dat = file.readline().strip()
    try:
      dat = conv(dat)
    except SyntaxError:
  ...
  def read_array_lo(self,dir,fil,rank,dims,dim_max):
    ...
    try:
      ...
      self.error('read_array_lo', 'Attribute '+l_filename+' is not set')
  ...
  def read_ch(self,dir,fil):
    ...
    try:
      ...
      self.error('read_ch',         'Attribute '+dir.strip()+'/'+fil+' is not set')
    dat = file.readline().strip()
    try:
      dat = conv(dat)
    except SyntaxError:
  ...
  def read_array_ch(self,dir,fil,rank,dims,dim_max):
    ...
    try:
      ...
      self.error('read_array_ch', 'Attribute '+l_filename+' is not set')
